...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean check1 = isEmailValid(email.getText().toString());
                boolean check2 = password.getText().toString().contains(" ");
                if (!check1)
                    Toast.makeText(Login.this, "Incorrect Email Format", Toast.LENGTH_SHORT).show();
                else if (check2)
                    Toast.makeText(Login.this, "Password Includes a space", Toast.LENGTH_SHORT).show();
                else {
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder forgotAlert = new AlertDialog.Builder(Login.this);
                final View forgotView = getLayoutInflater().inflate(R.layout.dialog_forgot_password, null);
                forgotAlert.setView(forgotView);

                ok_forgot = forgotView.findViewById(R.id.btnForgotOk);
                cancel_forgot = forgotView.findViewById(R.id.btnForgotCancel);
                forgotEmail = forgotView.findViewById(R.id.emailForgot);

                final ProgressDialog progressDialog = new ProgressDialog(Login.this);
                progressDialog.setMessage("Loading...");

                final AlertDialog dialog = forgotAlert.create();
                dialog.show();
                ...
                ok_forgot.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        boolean check3 = isEmailValid(forgotEmail.getText().toString());
                        if (!check3)
                            Toast.makeText(Login.this, "Incorrect Email Format", Toast.LENGTH_SHORT).show();
                        else {
                            progressDialog.show();
                            firebaseAuth.sendPasswordResetEmail(forgotEmail.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        startActivity(new Intent(forgotView.getContext(), Login.class));
